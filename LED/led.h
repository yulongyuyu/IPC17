...
typedef struct LED_Class{
    ...
    void (*set_level)(pLED_Class pinput, const int led_n, const led_bit led_level);
    void (*set_level_arr)(pLED_Class pinput, const led_bits led_sta);
    
    // void (*flip_level)(const int led_n);
    // void (*flip_level_arr)(led_bits led_sta);

    void (*read_level)(pLED_Class pinput, const int led_n, led_bit *led_level);
    void (*read_level_arr)(pLED_Class pinput, led_bits* led_sta);
